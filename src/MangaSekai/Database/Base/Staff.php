...
abstract class Staff implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MangaSekai\\Database\\Map\\StaffTableMap';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[StaffTableMap::COL_ID] = true;
        }
    ...
    public function setImage($v)
    {
        ...
        if ($this->image !== $v) {
            $this->image = $v;
            $this->modifiedColumns[StaffTableMap::COL_IMAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StaffTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StaffTableMap::COL_ID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MangaSekai\Database\Staff
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MangaSekai\Database\Staff The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StaffTableMap::COL_ID)) {
            $criteria->add(StaffTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(StaffTableMap::COL_NAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MangaSekai\Database\Staff (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MangaSekai\Database\Staff Clone of current object.
     * @throws PropelException
     */
