...
class SeriesTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'ChapterCount', 'PagesCount', 'Description', 'Synced', 'Image', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'chapterCount', 'pagesCount', 'description', 'synced', 'image', ),
        self::TYPE_COLNAME       => array(SeriesTableMap::COL_ID, SeriesTableMap::COL_NAME, SeriesTableMap::COL_CHAPTER_COUNT, SeriesTableMap::COL_PAGES_COUNT, SeriesTableMap::COL_DESCRIPTION, SeriesTableMap::COL_SYNCED, SeriesTableMap::COL_IMAGE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'chapter_count', 'pages_count', 'description', 'synced', 'image', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'ChapterCount' => 2, 'PagesCount' => 3, 'Description' => 4, 'Synced' => 5, 'Image' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'chapterCount' => 2, 'pagesCount' => 3, 'description' => 4, 'synced' => 5, 'image' => 6, ),
        self::TYPE_COLNAME       => array(SeriesTableMap::COL_ID => 0, SeriesTableMap::COL_NAME => 1, SeriesTableMap::COL_CHAPTER_COUNT => 2, SeriesTableMap::COL_PAGES_COUNT => 3, SeriesTableMap::COL_DESCRIPTION => 4, SeriesTableMap::COL_SYNCED => 5, SeriesTableMap::COL_IMAGE => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'chapter_count' => 2, 'pages_count' => 3, 'description' => 4, 'synced' => 5, 'image' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
