...
use MangaSekai\Database\Settings;
...
class SettingsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MangaSekai.Database.Map.SettingsTableMap';
     ...
     */
    const OM_CLASS = '\\MangaSekai\\Database\\Settings';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MangaSekai.Database.Settings';
     ...
     */
    const COL_VALUE = 'settings.value';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SettingsTableMap::COL_ID, SettingsTableMap::COL_NAME, SettingsTableMap::COL_VALUE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SettingsTableMap::COL_ID => 0, SettingsTableMap::COL_NAME => 1, SettingsTableMap::COL_VALUE => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MangaSekai\\Database\\Settings');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MangaSekai\Database\Settings) { // it's a model object
