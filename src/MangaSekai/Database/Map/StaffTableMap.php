...
class StaffTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MangaSekai.Database.Map.StaffTableMap';
     ...
     */
    const OM_CLASS = '\\MangaSekai\\Database\\Staff';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MangaSekai.Database.Staff';
     ...
     */
    const COL_ID = 'staff.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'staff.name';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MangaSekai\\Database\\Staff');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MangaSekai\Database\Staff) { // it's a model object
