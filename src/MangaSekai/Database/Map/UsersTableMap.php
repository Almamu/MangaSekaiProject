...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MangaSekai.Database.Map.UsersTableMap';
     ...
     */
    const OM_CLASS = '\\MangaSekai\\Database\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MangaSekai.Database.Users';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_USERNAME, UsersTableMap::COL_PASSWORD, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_USERNAME => 1, UsersTableMap::COL_PASSWORD => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MangaSekai\\Database\\Users');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MangaSekai\Database\Users) { // it's a model object
